...
import { Plus, X, Star, Upload, Home, Trash2, ChevronLeft } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm p-6 h-full flex flex-col">
        ...
        <div className="mb-6">
          <div className="flex justify-between mb-2 text-sm text-gray-600">
            ...
            <span>{currentStep === 1 ? "Basic Details" : "Property Details"}</span>
          </div>
          ...
          <div className="flex-1 overflow-y-auto pb-4">
            ...
            {currentStep === 1 && (
              <div className="space-y-6">
                ...
                <section>
                  <h2 className="text-md font-semibold mb-4 pb-2 border-b border-gray-200 bg-gradient-to-r from-teal-600 to-blue-600 bg-clip-text text-transparent">
                    Basic Information
                  </h2>
              ...
              <div className="space-y-6">
                ...
                <section>
                  <h2 className="text-md font-semibold mb-4 pb-2 border-b border-gray-200">
                    ...
                    <span className="block text-sm text-gray-500 mt-1">
                      Add one word per feature (e.g., 3 Bedrooms, Spacious)
                    </span>
                  </h2>
                ...
                <section>
                  <h2 className="text-md font-semibold mb-4 pb-2 border-b border-gray-200">
                    ...
                    <span className="block text-sm text-gray-500 mt-1">
                      Add lease rules (e.g., No pets allowed)
                    </span>
                  </h2>
