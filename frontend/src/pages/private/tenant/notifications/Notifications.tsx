...
const Notifications = () => {
  ...
  // Get notification link based on type (tenant-specific)
    ...
    switch (type) {
      ...
      case "SCREENING":
        if (notification.screeningId) {
          return `/tenant/screening/${notification.screeningId}/details`;
        }
              ...
              {loading && notifications.length === 0 ? (
                ...
                <div className="divide-y divide-gray-100">
                  {unreadNotifications.length > 0 && (
                    <div className="bg-emerald-50/30 py-2 px-4">
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain">
              {loading && notifications.length === 0 ? (
                ...
                <div className="divide-y divide-gray-100">
                  {unreadNotifications.length > 0 && (
                    <div className="bg-emerald-50/30 py-2 px-4 sticky top-0 z-10">
                      <p className="text-xs font-medium text-emerald-700">
                        Unread ({unreadNotifications.length})
                      </p>
                    </div>
...
const NotificationItem = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        whileHover={{ x: 2 }}
        className="absolute right-4 top-1/2 -translate-y-1/2 text-emerald-600 opacity-0 group-hover:opacity-100 transition-opacity"
      >
