              ...
              {loading && notifications.length === 0 ? (
                ...
                <div className="divide-y divide-gray-100">
                  {unreadNotifications.length > 0 && (
                    <div className="bg-green-50/30 py-2 px-4">
                  ...
                  {hasMore && (
                    <div ref={observerRef} className="p-4 text-center">
                      <div className="animate-spin rounded-full h-6 w-6 border-2 border-green-600 border-t-transparent mx-auto" />
                    </div>
                  )}
                </div>
              )}
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain">
              {loading && notifications.length === 0 ? (
                ...
                <div className="divide-y divide-gray-100">
                  {unreadNotifications.length > 0 && (
                    <div className="bg-green-50/30 py-2 px-4 sticky top-0 z-10">
                      <p className="text-xs font-medium text-green-700">
                        Unread ({unreadNotifications.length})
                      </p>
                    </div>
...
const NotificationItem = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        whileHover={{ x: 2 }}
        className="absolute right-4 top-1/2 -translate-y-1/2 text-green-600 opacity-0 group-hover:opacity-100 transition-opacity"
      >
