  ...
  return (
    <div className="min-h-svh grid lg:grid-cols-2 bg-gradient-to-br from-gray-50 to-gray-100 overflow-x-hidden">
      ...
      <div className="relative hidden bg-muted lg:block overflow-hidden">
        ...
        {/* Text Overlay with Right Entrance */}
        <div className="absolute bottom-10 left-10 right-10 z-20">
          <motion.div
            initial={{ opacity: 0, x: 50 }}  // Changed to slide from right
            animate={{ 
              opacity: 1, 
              x: 0,
              transition: { 
          ...
          >
            ...
            <p className="text-lg text-gray-100 opacity-95">
              Join thousands of landlords and tenants using RentEase
            </p>
          </motion.div>
        </div>
      </div>
      
      {/* Right Column - Registration Form with Left-to-Right Animations */}
      <motion.div 
      ...
      >
        ...
        <motion.div 
          ...
          initial={{ opacity: 0, x: -30 }}  // Start from left
          animate={{ opacity: 1, x: 0 }}
        ...
        {/* Form Container with Left-to-Right Animation */}
      ...
      {/* Mobile Background with Right Entrance */}
      <motion.div 
      ...
      >
        ...
        <motion.div
          ...
          initial={{ opacity: 0, x: 30 }}  // Changed to slide from right
          animate={{ 
            opacity: 1, 
            x: 0,
            transition: { 
        ...
        >
          ...
          <p className="text-sm text-gray-100 opacity-95">
            Join RentEase for seamless property management
          </p>
        </motion.div>
      </motion.div>
    </div>
