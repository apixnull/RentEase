    ...
    <div className="min-h-svh grid lg:grid-cols-2 bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="relative hidden bg-muted lg:block">
        ...
        <div className="absolute bottom-10 left-10 right-10 z-20 text-white">
          ...
          >
            <h2 className="text-3xl font-bold mb-2">Simplify Your Rental Experience</h2>
            <p className="text-lg opacity-90">
              Join thousands of landlords and tenants using RentEase for seamless property management
            </p>
          </motion.div>
        </div>
      </div>
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            >
              ...
              <p className="mt-2 text-gray-600">
                Start your journey with RentEase today
              </p>
            </motion.div>
