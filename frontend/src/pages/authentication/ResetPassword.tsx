...
import { Lock, Sparkles, Eye, EyeOff, Check, Zap } from "lucide-react";
...
const ResetPasswordForm = () => {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-5">
      ...
      <motion.button
        type="submit"
        disabled={!passwordOk || !match}
        whileHover={{ scale: !passwordOk || !match ? 1 : 1.02 }}
        whileTap={{ scale: !passwordOk || !match ? 1 : 0.98 }}
