      ...
      >
        ...
        <div className="hidden md:flex md:w-[40%] bg-gradient-to-b from-emerald-600 to-sky-600 text-white p-8 relative overflow-hidden">
          ...
          <div className="relative z-10 self-center">
            ...
            <p className="text-emerald-100 text-sm">We’ll send you a secure link</p>
          </div>
        </div>
        ...
        <div className="md:w-[60%] p-6 md:p-8">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-2 mb-6">
            <p className="text-gray-800 text-lg font-medium">Reset your password</p>
            <p className="text-gray-500 text-sm">
              Enter the email associated with your account. We will send a secure link
...
const ForgotPasswordForm = () => {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-5">
      ...
      {submitted && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-sm text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-lg p-3">
      ...
      <div className="text-center text-xs text-gray-500 pt-2">
        ...
        <Link to="/authentication/login" className="text-emerald-600 hover:text-emerald-800 font-medium">
          Sign in
        </Link>
      </div>
    </form>
