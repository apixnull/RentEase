        ...
        >
            <div className="relative overflow-hidden rounded-2xl">
                ...
                <div className="relative m-[1px] rounded-[15px] bg-white/70 backdrop-blur-md border border-white/50">
                    ...
                    <motion.div
                        aria-hidden
                        className="pointer-events-none absolute -top-10 -left-10 h-40 w-40 rounded-full bg-emerald-200/40 blur-3xl"
                    ...
                    <motion.div
                        aria-hidden
                        className="pointer-events-none absolute -bottom-10 -right-10 h-48 w-48 rounded-full bg-sky-200/40 blur-3xl"
