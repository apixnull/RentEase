...
import { getUserChatChannels, sendMessage, sendMessageCreateChannel, searchUsersForMessaging, getSpecificChannelMessages, markMessagesAsRead } from "../controllers/chatController.js";
...
router.get("/users/search", requireAuthentication(["TENANT", "LANDLORD"]), searchUsersForMessaging);
