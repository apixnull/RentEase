...
router.get("/listing/payment-success", requireAuthentication(["LANDLORD"]), getListingByUnitIdForSuccess);              // get listing by unitId for payment success page
router.get("/listing/:listingId/success", requireAuthentication(["LANDLORD"]), getLandlordListingInfoSuccess);            // get basic info when success (by listingId)
